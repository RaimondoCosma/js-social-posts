...
//         postItem.querySelector('.post-meta__icon').innerHTML = `<div style="width:60px; height:60px; border-radius:50%; background-color:lightgray; font-size:30px; font-weight:bold; text-align:center; line-height:60px">${onlyCapitalLetters(post.author.name)}</div>`;
//     }
